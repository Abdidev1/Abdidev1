# 💫 About Me:
Hi, I'm Abdullah!<br>I'm a 15-year-old developer from Lahore, Pakistan, with a passion for building immersive digital experiences and exploring the world of software engineering. Currently, I'm focusing on mastering cybersecurity and game development.<br>

🛠️ **What I’m Working On:**
* **Game Development:** Lead developer at Apex Realms Studios. I specialize in Luau and Roblox Studio, where I created Pixel Climb.
* **Web & Scripts:** Building projects using Python, JavaScript, HTML, and CSS.
* **Learning:** Currently diving deeper into backend systems and security protocols.

🚀 **Technical Skills:**
* **Languages:** Python, Luau, JavaScript, HTML/CSS
* **Platforms:** Roblox Studio, GitHub, VS Code
* **Interests:** Software Engineering, Cybersecurity, and Game Design

🏆 **Fun Facts:**
* I Have Contributed to 111m+ Visits On Roblox
